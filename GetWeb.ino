...
WiFiClient client;
  ...
  if (client.connect("time.org",  80)) {
    Serial.println("connected");
    //client.println("GET /index.html HTTP/1.0\r\n\r\n");
    client.println("GET /index.php HTTP/1.1");
    client.println("Host: www.time.org");
    client.println("User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:45.9) Gecko/20100101 Goanna/3.2 Firefox/45.9 PaleMoon/27.4.0");
...
contiene = c.indexOf("This page was served on");

if( contiene > 0) {  Serial.println(c); 

  }
  

contiene = c.indexOf("Paris");
...
if( contiene > 0) {         
  ...
  client.stop();   
  //
  Serial.println(c.substring(contiene, contiene+23) );
